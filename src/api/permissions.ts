export const PERMISSIONS = {
  ...
  // Conversation Status
  CONVERSATION_STATUS_CREATE: 'conversation_status.create',
  CONVERSATION_STATUS_READ: 'conversation_status.read',
  CONVERSATION_STATUS_UPDATE: 'conversation_status.update',
  CONVERSATION_STATUS_DELETE: 'conversation_status.delete',
...
export const PERMISSION_DEPENDENCIES: Record<Permission, Permission[]> = {
  ...
  // Conversation Status dependencies
  [PERMISSIONS.CONVERSATION_STATUS_CREATE]: [PERMISSIONS.CONVERSATION_STATUS_READ],
  [PERMISSIONS.CONVERSATION_STATUS_UPDATE]: [PERMISSIONS.CONVERSATION_STATUS_READ],
  [PERMISSIONS.CONVERSATION_STATUS_DELETE]: [PERMISSIONS.CONVERSATION_STATUS_READ],
  ...
  [PERMISSIONS.CONVERSATION_READ]: [
    ...
    PERMISSIONS.CLIENT_READ,
    PERMISSIONS.CONVERSATION_STATUS_READ,
  ],
  [PERMISSIONS.CONVERSATION_STATUS_READ]: [],
  ...
  [PERMISSIONS.PRODUCT_TAG_READ]: [],
  [PERMISSIONS.UNIT_READ]: [],
  [PERMISSIONS.QUICK_REPLY_READ]: [PERMISSIONS.BUSINESS_READ],
  [PERMISSIONS.EVENT_READ]: [],
  [PERMISSIONS.ORDER_READ]: [
    PERMISSIONS.CLIENT_READ,
    PERMISSIONS.PRODUCT_TAG_READ,
