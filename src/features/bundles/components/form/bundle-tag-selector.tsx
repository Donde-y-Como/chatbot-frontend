...
import { Search, Tag, X, Check, Plus } from 'lucide-react';
...
export function BundleTagSelector() {
            ...
            return (
              <FormItem className="space-y-4">
                <FormLabel className="text-base font-medium">
                  Seleccionar etiquetas para organizar tu paquete
                </FormLabel>
                ...
                <div className="space-y-3">
                  ...
                  <div className="text-xs text-muted-foreground">
                    {searchQuery ? (
                      <>Mostrando {availableTags.length} de {tags.length} etiquetas</>
                    ) : (
                    ...
                    <div className="text-center py-8 text-muted-foreground">
                      {searchQuery ? (
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-sm">Todas las etiquetas están seleccionadas</p>
                        </div>
                      )}
                    </div>
                  )}
                ...
                <div className="text-xs text-muted-foreground bg-muted/30 rounded-lg p-3">
                  <p>
                    💡 <strong>Consejo:</strong> Las etiquetas te ayudan a organizar y filtrar tus paquetes. 
                    Puedes seleccionar múltiples etiquetas haciendo clic en ellas.
                  </p>
                </div>
