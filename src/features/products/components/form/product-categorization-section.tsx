    ...
    <Card>
      ...
      <CardContent className='space-y-6'>
              ...
              <FormItem>
                ...
                {parentCategories.length > 0 ? (
                    ...
                    <div className='border rounded-md p-3 max-h-60 overflow-y-auto'>
                      <div className='space-y-2'>
                        {parentCategories.map((parentCategory) => {
                          ...
                          const isSelected =
                            field.value?.includes(parentCategory.id) || false
                  ...
                  <div className='text-center py-6 text-muted-foreground border rounded-md'>
                    ...
                    <p className='text-xs'>
                      Crea categorías desde la configuración para organizar tus
                      productos
                    </p>
                  </div>
                )}
        ...
        <TagSelector
          ...
          description='Seleccionar etiquetas para organizar tu producto'
          helperText='Las etiquetas te ayudan a organizar y filtrar tus productos. Puedes seleccionar múltiples etiquetas haciendo clic en ellas.'
        />
      </CardContent>
    </Card>
  )
    ...
    <div className='ml-8 space-y-1 animate-in slide-in-from-top-2 duration-200'>
      {parentCategory.subcategories?.map((subcategory) => (
        ...
        >
          ...
          />
          <div className='flex-1 min-w-0'>
            <p className='text-sm leading-none truncate'>{subcategory.name}</p>
