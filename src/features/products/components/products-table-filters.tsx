...
import { Category, ProductStatus, ProductTag, Unit } from '../types'
...
export const generateStatusOptions = () => [
  {
    value: ProductStatus.ACTIVO,
    label: 'Activo',
    icon: Package,
  },
  {
    value: ProductStatus.INACTIVO,
    label: 'Inactivo',
    icon: Package,
  },
  {
    value: ProductStatus.SIN_STOCK,
    label: 'Sin Stock',
    icon: Package,
  },
]
...
export const generateUnitOptions = (units: Unit[]) =>
  units.map((unit) => ({
    value: unit.id,
