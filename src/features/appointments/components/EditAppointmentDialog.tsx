...
// import { formatSlotHour } from '@/features/appointments/utils/formatters.ts'
//
...
//     JSON.stringify(appointment.timeRange)
//   )
...
//             const existingEmployeeIds = slots[existingSlotIndex].employees.map(
//               (e) => e.id
//             )
//
...
//     ? availableSlots.find((s) => JSON.stringify(s.slot) === selectedSlot)
//         ?.employees || []
//     : []
//
//   // Get selected employees
//   const selectedEmployees = slotEmployees.filter((emp) =>
...
//                             variant={
//                               selectedSlot === JSON.stringify(slot.slot)
//                                 ? 'default'
//                                 : 'outline'
//                             }
//                             className='justify-start'
//                             onClick={() =>
//                               setSelectedSlot(JSON.stringify(slot.slot))
//                             }
//                           >
...
//                   </Button>
//                 </div>
//                 <Button onClick={() => setActiveStep(4)}>Continuar</Button>
//               </div>
//             </TabsContent>
//
//             {/* Step 4: Confirmation */}
...
//                   <CardDescription>
//                     Verifica los cambios en tu cita
//                   </CardDescription>
//                 </CardHeader>
