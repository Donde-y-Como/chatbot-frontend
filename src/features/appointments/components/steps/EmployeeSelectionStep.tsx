...
import { CheckCircle, Loader2, Search, User, X } from 'lucide-react' // Agregamos iconos para búsqueda
...
export function EmployeeSelectionStep({
  ...
  // Filtramos los empleados según la búsqueda con useMemo para optimizar rendimiento
  ...
  return (
    <div className="space-y-4 h-[22rem]">
        ...
        <>
          ...
          {searchQuery && (
            <p className="text-xs text-muted-foreground">
              {filteredEmployees.length} {filteredEmployees.length === 1 ? 'resultado' : 'resultados'} encontrados
            </p>
          )}
            ...
            <div className="p-4">
              {filteredEmployees.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center p-8 text-muted-foreground">
                  ...
                  <p className="text-center">No se encontraron empleados con ese nombre</p>
                  <Button
                    variant="link"
                    onClick={clearSearch}
                    className="mt-2"
      ...
      ) : loadingEmployees ? (<div>
        <p className="mb-2 text-center text-sm text-muted-foreground">Buscando empleados disponibles en el horario seleccionado...</p>
