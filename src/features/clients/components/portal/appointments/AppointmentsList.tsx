...
export function AppointmentsList({ token }: AppointmentsListProps) {
  const { data: appointments, isLoading } = useClientPortalAppointments(
    token,
    true
  )
          ...
          <div className='space-y-4'>
            {appointments.map((appointment) => {
              ...
              return (
                <Card
                  key={appointment.id}
                  className='border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-300 overflow-hidden group'
                >
                        ...
                        <div className='flex items-start space-x-3'>
                          ...
                          <div className='flex-1'>
                            ...
                            <p className='font-medium text-gray-900 dark:text-white'>
                              {appointment.employeesNames?.join(', ') ||
                                'Por asignar'}
                            </p>
                          </div>
                        </div>
