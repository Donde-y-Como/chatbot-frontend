...
export default function ProfileHeader({ user, isEditingProfile, setIsEditingProfile, form, handleLogoUpload, saveProfileChanges, isUploading }) {
  return (
            ...
            <FormControl>
              <div className="flex items-center space-x-4">
                <Avatar className="h-44 w-44">
                  <AvatarImage src={field.value || user?.logo} alt="Logo" className="h-full w-full rounded-full overflow-hidden" />
